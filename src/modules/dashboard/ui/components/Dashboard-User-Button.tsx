...
import { GeneratedAvatar } from "@/components/ui/views/generated-avatar";
  ...
  const onLogout = () => {
    ...
    if(isMobile){
        return(
            ...
            />)}
            <div className="flex flex-col gap-1 text-left ml-2 overflow-hidden flex-1 min-w-0">
    ...
    return(
        ...
        <DropdownMenu>
            ...
            <DropdownMenuContent align="end" side="right" className="w-72">
                ...
                <DropdownMenuSeparator/>
                <DropdownMenuItem
                className="flex cursor-pointer items-center justify-between text-black bg-white">
                    Billing
